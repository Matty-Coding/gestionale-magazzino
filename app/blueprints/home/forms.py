...
class FornitoreForm(FlaskForm):
    ...
    partita_iva = StringField(
        ...
        validators=[
            ...
            Length(
                min=11, max=11, message="La partita IVA deve essere di 11 caratteri!"
            ),
            Regexp(
                regex=r"^[0-9]{11}$",
    ...
    telefono = TelField(
        ...
        validators=[
            ...
            Length(
                min=10,
                max=10,
                message="Il numero di telefono deve essere di 10 caratteri!",
            ),
            Regexp(
                regex=r"^[0-9]{10}$",
...
class ProdottoForm(FlaskForm):
    ...
    nome = StringField(
        ...
        validators=[
            ...
            Length(
                min=1, max=50, message="Il nome deve essere di massimo 100 caratteri!"
            ),
            Regexp(
                regex=r"^[A-Za-z0-9 ]+$",
    ...
    descrizione = TextAreaField(
        "Descrizione", render_kw={"placeholder": "Descrizione del prodotto..."}
    )
    ...
    prezzo = StringField(
        ...
        validators=[
            ...
            Length(
                min=3,
                max=7,
                message="Il prezzo deve essere almeno 3 caratteri e massimo 7!",
            ),
            Regexp(
    ...
    quantita = IntegerField("Quantità", render_kw={"placeholder": "10"})
...
class UtenteForm(FlaskForm):
    username = StringField(
        ...
        validators=[
            ...
            Length(
                min=3,
                max=25,
                message="L'username deve essere compreso tra 3 e 25 caratteri!",
            ),
            Regexp(
    ...
    email = EmailField(
        ...
        validators=[
            ...
            Length(
                max=120, message="L'email non può essere più lunga di 120 caratteri!"
            ),
        ],
    )
